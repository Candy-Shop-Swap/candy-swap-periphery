// File: @candyswap\candy-swap-core\contracts\interfaces\ICandyFactory.sol
...
// File: @candyswap\candy-swap-core\contracts\interfaces\ICandyPair.sol
...
library CandyLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'1bf62b074b05054f9c4f737a0289314333b4d3da1999b0d46b792acc028694f8' // init code hash
            ))));
    }
...
// File: contracts\CandyRouter01.sol

pragma solidity =0.6.6;

contract CandyRouter01 is ICandyRouter01 {
    ...
    function _swap(uint[] memory amounts, address[] memory path, address _to) private {
        for (uint i; i < path.length - 1; i++) {
            ...
            ICandyPair(CandyLibrary.pairFor(factory, input, output)).swap(amount0Out, amount1Out, to, new bytes(0));
        }
    }
    function swapExactTokensForTokens(
        uint amountIn,
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, CandyLibrary.pairFor(factory, path[0], path[1]), amounts[0]);
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) public pure override returns (uint amountIn) {
        return CandyLibrary.getAmountOut(amountOut, reserveIn, reserveOut);
    }
